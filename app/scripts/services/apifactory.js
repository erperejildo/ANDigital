...
angular.module('andigitalApp')
  .service('apiFactory', function ($http) {
    ...
    var urlBase  	 = 'https://api.foursquare.com/v2/venues/search?client_id=' + cliendID + '&client_secret=' + clientSecret + '&v=20130815&ll=40.7,-74&query=sushi';

    apiFactory.getRecommended = function () {
